            ...
            <div class="mx-8 mt-8 rounded-2xl border border-emerald-200 bg-emerald-50 p-6">
                ...
                <div class="grid md:grid-cols-3 gap-4">
                    ...
                    <div class="bg-white rounded-xl border border-emerald-100 p-5 shadow-sm">
                        ...
                        <h3 class="mt-2 text-xl font-bold text-slate-800">1234567890</h3>
                    ...
                    <div class="bg-white rounded-xl border border-emerald-100 p-5 shadow-sm">
                        ...
                        <h3 class="mt-2 text-xl font-bold text-slate-800">0987654321</h3>
                        <p class="mt-2 text-sm text-emerald-700 font-semibold">
                            a.n. KOPERASI SEJAHTERA MANDIRI
                        </p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl border border-emerald-100 p-5 shadow-sm">
                        <p class="text-sm text-slate-500">Bank BRI</p>
                        <h3 class="mt-2 text-xl font-bold text-slate-800">1122334455</h3>
                        <p class="mt-2 text-sm text-emerald-700 font-semibold">
                            a.n. KOPERASI SEJAHTERA MANDIRI
                        </p>
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function setNominal() {
        ...
        if (jenis.value === 'pokok') {

            jumlah.value = 100000;
            jumlah.readOnly = true;
            jumlah.classList.add('bg-gray-100');

        }

        else if (jenis.value === 'wajib') {
        ...
        else if (jenis.value === 'sukarela') {

            jumlah.value = '';
            jumlah.readOnly = false;
            jumlah.classList.remove('bg-gray-100');
    ...
    jenis.addEventListener('change', setNominal);
